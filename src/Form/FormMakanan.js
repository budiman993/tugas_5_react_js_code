		...
		return(
			<>
				<center>
					...
					<input
						onChange={this.hendleChange} type="text" value={this.state.pesanan} ref={this.pesanan} placeholder="Masukan Pesanan Anda"
					/>

					<input
						type="number" value={this.state.jumlah} onChange={this.hendleChangeJumlah} placeholder="Masukan Jumlah Pesanan"
					/>
